...
var BaseFoldMode = ace.acequire('ace/mode/folding/fold_mode').FoldMode;

var FoldMode = function (commentRegex) {
  if (commentRegex) {
...
(function () {
  ...
  this.getFoldWidgetRange = function (session, foldStyle, row, forceMultiline) {
    var line = session.getLine(row), match;
  ...
  this.getCommentRegionBlock = function (session, line, row) {
    ...
    var endRow = row;
    if (endRow > startRow) {
      return new AceRange(startRow, startColumn, endRow, line.length);
    }
  };
